OC.L10N.register(
    ...
    "Mounting of archive files is disabled. You can enable it in your personal settings." : "封存檔掛載功能已停用。您可以在個人設定中啟用此功能。",
    ...
    "Unable to query the archive-format support matrix." : "無法查詢封存格式支援矩陣：",
    "Unable to query the information about the available archive backend drivers." : "無法查詢關於可用的封存後端驅動程式得的資訊。",
    ...
    "Archive Mounting" : "封存檔掛載",
    "disable mounting of archive files by default" : "預設停用封存檔掛載",
    "This only defines the default for all users, everybody may override it in the personal settings." : "這僅是為所有使用者設定的預設值，每位使用者皆可在個人設定中覆寫此設定。",
    "Diagnostics" : "診斷",
    ...
    "Mount Options" : "掛載選項",
    "disable mounting of archive files" : "停用封存檔掛載",
    "The administrator has disabled the mounting of archive files by default, but you may enable it here." : "管理員已預設停用封存檔的掛載功能，但您可在此處啟用此功能。",
    ...
    "mount the archive as default action by a simple click" : "只要輕點，即可將掛載封存檔設定為預設動作",
    ...
    "too large" : "太大",
    "unknown" : "未知",
    "Cancelling the background job failed with error {status}, \"{statusText}\"." : "取消背景作業失敗，錯誤 {status}，「{statusText}」。",
    ...
    "basename" : "基礎名稱",
    "Pending Background Jobs" : "擱置中的背景作業",
    "No Pending Background Jobs" : "無擱置中的背景作業",
    "Cancel Job" : "取消作業",
    "mount" : "掛載",
    "extract" : "擷取",
    ...
    "Archive" : "壓縮檔",
    "The archive \"{archivePath}\" will be extracted asynchronously to \"{targetPath}\", you will be notified on completion." : "封存檔「{archivePath}」將以非同步方式解壓縮至「{targetPath}」，完成時會通知您。",
    "The archive \"{archivePath}\" has been extracted to \"{targetPath}\"." : "封存檔「{archivePath}」已解壓縮至「{targetPath}」。",
    ...
    "The archive \"{archivePath}\" will be mounted asynchronously on \"{mountPointPath}\", you will be notified on completion." : "封存檔「{archivePath}」將會非同步掛載於「{mountPointPath}」，完成後會通知您。",
    ...
    "Cancelling %s-job for archive file \"%s\" failed." : "取消 %s 作業失敗，針對封存檔「%s」。",
    "Shared folder with id \"%1$s\" does not exist." : "ID 為「%1$s」的分享資料夾不存在。",
