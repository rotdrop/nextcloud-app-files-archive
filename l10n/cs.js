OC.L10N.register(
    ...
    "Unable to open parent-folder \"%1$s\" of moint-point \"%2$s\": %3$s." : "Nedaří se otevřít nadřazenou složku „%1$s“ přípojného bodu „%2$s: %3$s.",
    ...
    "Directory \"%s\" should be a mount point, but it is not." : "Složka „%s“ by měla být přípojným bodem, ale není.",
    ...
    "{archiveFileName} will be replaced by the file-name of the archive-file without extensions." : "{archiveFileName} bude nahrazeno názvem souboru (bez přípon).",
