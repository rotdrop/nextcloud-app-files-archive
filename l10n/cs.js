OC.L10N.register(
    ...
    "mount the archive as default action by a simple click" : "připojit archiv jako výchozí akce při kliknutí",
    ...
    "Archive" : "Archiv",
    "Mounting the archive was seemingly successful, but navigating to the mount point failed: \"{error}\"." : "Připojení archivu bylo zdánlivě úspěšné, ale navigace do přípojného bodu se nezdařila: „{error}“.",
    "The archive \"{archivePath}\" is already mounted on \"{mountPointPath}\"." : "Archiv „{archivePath}“ už je připojený v „{mountPointPath}.",
    "The archive \"{archivePath}\" will be mounted asynchronously on \"{mountPointPath}\", you will be notified on completion." : "Archiv „{archivePath}“ bude asynchronně připojen do „{mountPointPath}“ – na dokončení budete upozorněni.",
