OC.L10N.register(
    ...
    "Post to end-point \"%s\" not implemented." : "\"%s\" uç noktasına gönderme özelliği henüz eklenmedi.",
    "Post to base-url of app \"%s\" not allowed." : "\"%s\" uygulamasının temel adresine ekleme yapılmasına izin verilmiyor.",
    "Get from end-point \"%s\" not implemented." : "\"%s\" uç noktasından alma özelliği henüz eklenmedi.",
    "\"%1$s\" is already mounted on \"%2$s\"." : "\"%1$s\" zaten \"%2$s\" üzerine takılmış.",
    "Unable to open parent-folder \"%1$s\" of moint-point \"%2$s\": %3$s." : "\"%2$s\" takma noktasının \"%1$s\" üst klasörü açılamadı: %3$s.",
    ...
    "Directory \"%s\" should be a mount point, but it is not." : "\"%s\" klasörü bir takma noktası olmalı ancak değil.",
    "Archive \"%1$s\" has been unmounted from \"%2$s\"." : "\"%1$s\" arşivi \"%2$s\" üzerinden çıkarıldı.",
    "Only the pass-phrase may be changed for an existing mount." : "Var olan bir takmanın yalnızca parolası değiştirilebilir.",
    ...
    "Thge personal setting \"%1$s\" is read-only" : "\"%1$s\" kişisel ayarı salt okunur",
    ...
    "{archiveFileName} will be replaced by the file-name of the archive-file without extensions." : "{archiveFileName} yerine uzantısı olmadan arşiv dosyasının adı gelir.",
    ...
    "Patching the pass-phrase failed with error {status}, \"{statusText}\"." : "Parola değişikliği {status}, \"{statusText}\" sorunu nedeniyle yerine getirilemedi.",
    "Mount Archive" : "Arşiv takma",
    "Unable to obtain mount-status for archive-file \"{archivePath}\"." : "\"{archivePath}\" arşiv dosyası için takılma durumu alınamadı.",
