OC.L10N.register(
    ...
    "Mounting {source} at {destination} has failed." : "Einhängen von {source} bei {destination} ist fehlgeschlagen.",
    ...
    "automatically change the mount point name if it already exists" : "den Namen des Einhängepunktes automatisch ändern, falls der Name bereits verwendet wird",
    ...
    "automatically change the target folder name if the target folder already exists" : "den Namen des Ziel-Ordners automatisch ändern, falls der Name bereits vorhanden ist",
    ...
    "uncompressed size" : "dekomprimierte Grö´ße",
