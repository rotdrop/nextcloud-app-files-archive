OC.L10N.register(
    ...
    "The archive file \"%1$s\" appears to be a zip-bomb: uncompressed size %2$s > admin limit %3$s." : "Die Archive-Datei \"%1$s\" scheine eine ZIP-Bombe zu sein: dekomprimierte Größe %2$s > Administrations-Limit %3$s.",
    ...
    "Unable to obtain mount-status for archive file \"{archivePath}\"." : "Kann den Einhänge-Status für die Archivdatei \"{archivePath}\" nicht ermitteln.\"",
