OC.L10N.register(
    ...
    "The archive-file \"%1$s\" appears to be a zip-bomb: uncompressed size %2$s > admin limit %3$s." : "Die Archive-Datei \"%1$s\" scheine eine ZIP-Bombe zu sein: dekomprimierte Größe %2$s > Administrator-Limit %3$s.",
    "The archive-file \"%1$s\" is too large: uncompressed size %2$s > user limit %3$s." : "Die Archive-Datei \"%1$s\" ist zu groß: dekomprimierte Größe %2$s > Benutzer*in-Limit %3$s.",
    "Unable to open the target parent-folder \"%s\"." : "Kann den Eltern-Ordner \"%s\" nicht öffnen.",
    "The target-folder \"%s\" already exists and auto-rename is not enabled." : "Der Ziel-Ordner \"%s\" existiert bereits und automatische Konfliktauflösung ist nicht aktiviert.",
    ...
    "Unable to open parent-folder \"%1$s\" of moint-point \"%2$s\": %3$s." : "Kann den Eltern-Ordner \"%1$s\" des Einhänge-Punkts \"%2$s\" nicht öffnen: %3$s.",
    ...
    "Unable to update the file cache for the mount-point \"%1s\": %2$s." : "Kann den Datei-Cache für den Einhänge-Punkt \"%1s\" nicht aktualisieren: %2$s.",
    ...
    "The target folder template \"%1$s\" must contain the archive-file placeholder \"%2$s\"." : "Die Schablone für den Zielordner-Namen \"%1$s\" muss den Platzhalter \"%2$s\" für den Archivnamen enthalten.",
    ...
    "Security Options" : "Einstellunhen zur Sicherheit",
    "Administrative size limit: {value}" : "Größenbegrenzen durch Administrator*innen: {value}",
    "Mount Options" : "Einhänge-Optionen",
    "Template for the default-name of the mount-point" : "Schablone für den voreingestellten Namen des Einhänge-Punkts",
    "{archiveFileName} will be replaced by the file-name of the archive-file without extensions." : "{archiveFileName} wird durch den Dateinamen der Archiv-Datei ohne Dateinamenserweiterungen ersetzt.",
    "strip common path prefix by default" : "gemeinsamen Dateipfad-Präfix normalerweise entfernen",
    "automatically change the mount-point name if it already exists" : "den Namen des Einhänge-Punktes automatisch ändern, falls der Name bereits in Verwendung ist",
    "Extraction Options" : "Einstellungen für das Entpacken",
    "Template for the default-name of the extraction folder" : "Schablone für den voreingestellten Ziel-Ordner für das Entpacken",
    ...
    "Not mounted, create a new mount-point:" : "Nicht eingehängt, erzeuge einen neuen Einhänge-Punkt:",
    "base-name" : "Basisname",
    ...
    "Archive-extraction failed with error {status}, \"{statusText}\"." : "Entpacken des Archivs ist fehlgeschlagen, Fehler-Code {status}, \"{statusText}\".",
    "Patching the pass-phrase failed with error {status}, \"{statusText}\"." : "Das Ändern des Passworts für aktive Einhänge-Punkte ist fehlgeschlagen, Fehler-Code {status}, \"{statusText}\".",
    ...
    "Blocked by Windows Parental Controls (Microsoft)" : "Von Windows-Kindersicherung geblockt (Microsoft)",
