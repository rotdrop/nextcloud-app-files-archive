OC.L10N.register(
    ...
    "Universal converter \"%1$s\" has failed trying to convert MIME type \"%2$s\"" : "Das Konvertierungsprogramm \"%1$s\" konnte eine Datei mit dem MIME-Typ \"%2$s\" nicht konvertieren",
    "Converter \"%1$s\" has failed trying to convert MIME type \"%2$s\"" : "Das Konvertierungsprogramm \"%1$s\" konnte eine Datei mit dem MIME-Typ \"%2$s\" nicht konvertieren",
    ...
    "Archive" : "Archiv",
    "The archive \"{archivePath}\" will be extracted asynchronously to \"{targetPath}\", you will be notified on completion." : "Das Archiv \"{archivePath}\" wird asynchron auf \"{targetPath}\" ausgepackt. Sie werden nach Abschluss benachrichtigt.",
    ...
    "The archive \"{archivePath}\" will be mounted asynchronously on \"{mountPointPath}\", you will be notified on completion." : "Das Archiv \"{archivePath}\" wird asynchron auf \"{mountPointPath}\" eingehängt. Sie werden nach Abschluss benachrichtigt.",
