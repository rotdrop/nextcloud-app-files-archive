OC.L10N.register(
    ...
    "Your archive file {source} has been mounted as a virtual folder at {destination}." : "Ihre Archivdatei {source} wurde als virtueller Ordner unter {destination} gemountet.",
    "Your archive file {source} has been extracted to {destination}." : "Ihre Archivdatei {source} wurde nach {destination} extrahiert.",
    "Mounting {source} at {destination} has failed: {message}" : "Mounten von {source} bei {destination} ist fehlgeschlagen: {message}",
    "Extacting {source} to {destination} bas failed: {message}" : "Extrahieren von {source} nach {destination} ist fehlgeschlagen: {message}",
