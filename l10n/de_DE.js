OC.L10N.register(
    ...
    "The \"%1$s\" driver could handle this format, but it is not installed." : "Der \"%1$s\"-Treiber könnte dieses Format verarbeiten, ist aber nicht installiert.",
    ...
    "Supported Drivers" : "Unetrstützte Treiber",
    ...
    "mount" : "Mount",
    "extract" : "Entpacken",
    "Common prefix {prefix} will be stripped." : "Gemeinsamer Präfix {prefix} wird entfernt.",
