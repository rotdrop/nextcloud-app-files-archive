OC.L10N.register(
    ...
    "Unable to open parent-folder \"%1$s\" of moint-point \"%2$s\": %3$s." : "Unable to open parent-folder \"%1$s\" of moint-point \"%2$s\": %3$s.",
    ...
    "Directory \"%s\" should be a mount point, but it is not." : "Directory \"%s\" should be a mount point, but it is not.",
    "Archive \"%1$s\" has been unmounted from \"%2$s\"." : "Archive \"%1$s\" has been unmounted from \"%2$s\".",
    "Only the pass-phrase may be changed for an existing mount." : "Only the pass-phrase may be changed for an existing mount.",
    ...
    "Thge personal setting \"%1$s\" is read-only" : "Thge personal setting \"%1$s\" is read-only",
    ...
    "{archiveFileName} will be replaced by the file-name of the archive-file without extensions." : "{archiveFileName} will be replaced by the file-name of the archive-file without extensions.",
    ...
    "Patching the pass-phrase failed with error {status}, \"{statusText}\"." : "Patching the pass-phrase failed with error {status}, \"{statusText}\".",
