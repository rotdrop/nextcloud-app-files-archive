OC.L10N.register(
    ...
    "The archive file \"%1$s\" is too large: uncompressed size %2$s > user limit %3$s." : "封存檔案「%1$s」太大了：未壓縮大小 %2$s > 使用者上限 %3$s。",
    ...
    "Extacting {source} to {destination} bas failed: {message}" : "將 {source} 提取到 {destination} 失敗：{message}",
