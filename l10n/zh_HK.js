OC.L10N.register(
    ...
    "Failed to mount archive file \"{archivePath}: {message}\"." : "無法掛載封存檔案 「{archivePath}：{message}」。",
    "Failed to mount archive file \"{archivePath}\"." : "無法掛載封存檔案 「{archivePath}」。",
    "Unable to obtain mount status for archive file \"{archivePath}: {message}\"." : "無法獲取封存檔案 「{archivePath}」的掛載狀態：{message}。",
    "false" : "錯"
},
"nplurals=1; plural=0;");
