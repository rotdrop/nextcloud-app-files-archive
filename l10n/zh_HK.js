OC.L10N.register(
    ...
    "The archive-file \"%1$s\" appears to be a zip-bomb: uncompressed size %2$s > admin limit %3$s." : "封存檔「%1$s」似乎是 zip 炸彈：未壓縮大小 %2$s > 管理大小 %3$s。",
    ...
    "Unable to update the file cache for the mount-point \"%1s\": %2$s." : "無法更新掛載點的檔案快取「%1s」：%2$s。",
    "\"%s\" is not mounted." : "未掛載 “%s”。",
    "Directory \"%s\" should be a mount point, but it is not." : "目錄「%s」應該為掛載點，但它並不是。",
    "Archive \"%1$s\" has been unmounted from \"%2$s\"." : "封存檔「%1$s」已從「%2$s」取消掛載。",
    "Only the pass-phrase may be changed for an existing mount." : "僅能變更現有掛載的密碼片語。",
    ...
    "{archiveFileName} will be replaced by the file-name of the archive-file without extensions." : "{archiveFileName} 將取代為封存檔的檔案名稱，不包含副檔名。",
    ...
    "Patching the pass-phrase failed with error {status}, \"{statusText}\"." : "修補通關密語失敗，錯誤 {status}，「{statusText}」。",
    "Mount Archive" : "掛載封存檔",
