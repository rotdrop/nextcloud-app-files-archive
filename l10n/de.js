OC.L10N.register(
    ...
    "Cancelling %1$s-job for archive file \"%2$s\" failed." : "Das Abbrechen des %1$s-Jobs für die Archivdatei \"%2$s\" ist fehlgeschlagen.",
    "Mounting of archive files is disabled. You can enable it in your personal settings." : "Das Einhängen von Archivdateien ist deaktiviert. Es kann in Ihren persönlichen Einstellungen aktiviert werden.",
    ...
    "Your archive file {source} has been mounted as a virtual folder at {destination}. In order to unmount it it is safe to just delete the mount point {destination}. This will do no harm to the archive file and just issue an \"unmount\" action. Please note that the virtual folder is read-only." : "Deine Archivdatei {source} wurde als virtueller Ordner unter {destination} bereitgestellt. Um die Bereitstellung aufzuheben, kannst du einfach das Bereitstellungsziel {destination} löschen. Dadurch wird die Archivdatei nicht angerührt, sondern es wird lediglich eine \"Unmount\"-Aktion ausgeführt. Bitte beachte, dass der virtuelle Ordner schreibgeschützt ist.",
    "Your archive file {source} has been extracted to {destination}. The archive contents reside there as ordinary files. Please feel free to use those as it pleases you. There is not automatic cleanup, the extracted files will remain in your file-space until you delete them manually. Just delete the folder {destination} if you have no more use of those files. Please note also that any changes committed to the extracted files will not be written back to the archive file {source}." : "Die Archivdatei {source} wurde nach {destination} entpackt. Die Archivinhalte liegen dort als gewöhnliche Dateien vor. Diese können nach Belieben verwendet werden. Es erfolgt keine automatische Bereinigung. Die entpackten Dateien verbleiben in deinem Dateibereich, bis sie manuell gelöscht werden. Wenn die Dateien nicht mehr benötigt werden, einfach den Ordner {destination} löschen. Bitte beachten, dass an den entpackten Dateien vorgenommene Änderungen nicht in die Archivdatei {source} zurückgeschrieben werden.",
    ...
    "Extracting {source} to {destination} has failed." : "{source} konnte nicht nach {destination} extrahiert werden.",
    "Internal error, unsupported notification subject: \"%1s\"." : "Interner Fehler, nicht unterstützter Benachrichtigung Betreff: \"%1s\".",
    ...
    "This only defines the default for all users, everybody may override it in the personal settings." : "Dies definiert nur die Standardeinstellung für alle Benutzer, jeder kann sie in den persönlichen Einstellungen überschreiben.",
    "Archive Mounting" : "Einhängen von Archiven",
    "disable mounting of archive files by default" : "Standardmäßig das Einhängen von Archivdateien deaktivieren",
    ...
    "disable mounting of archive files" : "Einhängen von Archivdateien deaktivieren",
    "The administrator has disabled the mounting of archive files by default, but you may enable it here." : "Die Administration hat das Einhängen von Archivdateien standardmäßig deaktiviert, es kann jedoch hier aktiviert werden.",
    ...
    "mount the archive as default action by a simple click" : "Das Archiv als Standardaktion durch einen einfachen Klick einhängen",
    ...
    "_Mount Point_::_Mount Points_" : ["Einhängepunkt","Einhängepunkte"],
    "Job type: {type}" : "Auftragstyp: {type}.",
    "Mount Archive" : "Archiv einhängen",
    "Extract here" : "Hier entpacken",
    "Extract the archive to a new folder in the current directory" : "Das Archiv in einen neuen Ordner im aktuellen Verzeichnis entpacken",
    "Archive" : "Archiv",
    "The archive \"{archivePath}\" will be extracted asynchronously to \"{targetPath}\", you will be notified on completion." : "Das Archiv \"{archivePath}\" wird asynchron auf \"{targetPath}\" ausgepackt. Du wirst nach Abschluss benachrichtigt.",
    "The archive \"{archivePath}\" has been extracted to \"{targetPath}\"." : "Das Archiv \"{archivePath}\" wurde unter \"{targetPath}\" ausgepackt.",
    "Extraction request failed with error {status}, \"{statusText}\"." : "Anfrage zum Auspacken ist mit Fehler {status} fehlgeschlagen, \"{statusText}\".",
    ...
    "The archive \"{archivePath}\" will be mounted asynchronously on \"{mountPointPath}\", you will be notified on completion." : "Das Archiv \"{archivePath}\" wird asynchron auf \"{mountPointPath}\" eingehängt. Du wirst nach Abschluss benachrichtigt.",
