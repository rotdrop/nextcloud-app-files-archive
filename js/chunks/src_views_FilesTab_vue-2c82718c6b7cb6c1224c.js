...
/* harmony import */ var _nextcloud_dialogs_style_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @nextcloud/dialogs/style.css */ "./node_modules/@nextcloud/dialogs/dist/style.css");
...
/* harmony import */ var js_md5__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! js-md5 */ "./node_modules/js-md5/src/md5.js");
/* harmony import */ var js_md5__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(js_md5__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _rotdrop_nextcloud_vue_components_lib_components_FilePrefixPicker_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @rotdrop/nextcloud-vue-components/lib/components/FilePrefixPicker.vue */ "./repositories/rotdrop/nextcloud-vue-components/lib/components/FilePrefixPicker.vue");
/* harmony import */ var vue_material_design_icons_Cancel_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! vue-material-design-icons/Cancel.vue */ "./node_modules/vue-material-design-icons/Cancel.vue");
/* harmony import */ var vue_material_design_icons_NetworkOff_vue__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! vue-material-design-icons/NetworkOff.vue */ "./node_modules/vue-material-design-icons/NetworkOff.vue");
/* harmony import */ var _config_ts__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../config.ts */ "./src/config.ts");
/* harmony import */ var _console_ts__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../console.ts */ "./src/console.ts");
/* harmony import */ var _toolkit_types_axios_type_guards_ts__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../toolkit/types/axios-type-guards.ts */ "./src/toolkit/types/axios-type-guards.ts");
/* harmony import */ var _toolkit_util_file_node_busy_indicator_ts__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../toolkit/util/file-node-busy-indicator.ts */ "./src/toolkit/util/file-node-busy-indicator.ts");
/* harmony import */ var _toolkit_util_file_node_helper_ts__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../toolkit/util/file-node-helper.ts */ "./src/toolkit/util/file-node-helper.ts");
/* harmony import */ var _toolkit_util_generate_url_ts__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../toolkit/util/generate-url.ts */ "./src/toolkit/util/generate-url.ts");
/* harmony import */ var _toolkit_util_initial_state_ts__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../toolkit/util/initial-state.ts */ "./src/toolkit/util/initial-state.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*@__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(__props, {
    ...
    const props = __props;
    _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].info('PROPS', {
      props
    });
    const setBusyState = state => {
      (0,_toolkit_util_file_node_busy_indicator_ts__WEBPACK_IMPORTED_MODULE_16__.setFileNodeBusy)(props.node, state);
    };
    ...
    const fileName = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => props.node ? props.node.path + '/' + props.node.basename : null);
    ...
    const initialState = (0,_toolkit_util_initial_state_ts__WEBPACK_IMPORTED_MODULE_19__["default"])();
    ...
    const openMountTarget = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => (0,js_md5__WEBPACK_IMPORTED_MODULE_9__.md5)((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_7__.generateUrl)('') + _config_ts__WEBPACK_IMPORTED_MODULE_13__.appName + '-open-archive-mount'));
    ...
    const archiveStatusText = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => {
      if (archiveStatus.value === ArchiveStatusOk) {
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)(_config_ts__WEBPACK_IMPORTED_MODULE_13__.appName, 'ok');
      } else if (archiveStatus.value & ArchiveStatusBomb) {
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)(_config_ts__WEBPACK_IMPORTED_MODULE_13__.appName, 'zip bomb');
      } else if (archiveStatus.value & ArchiveStatusTooLarge) {
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)(_config_ts__WEBPACK_IMPORTED_MODULE_13__.appName, 'too large');
      }
      return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)(_config_ts__WEBPACK_IMPORTED_MODULE_13__.appName, 'unknown');
    });
    ...
    const commonPathPrefix = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => !archiveInfo.value || archiveInfo.value.commonPathPrefix === undefined ? (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)(_config_ts__WEBPACK_IMPORTED_MODULE_13__.appName, 'unknown') : '/' + archiveInfo.value.commonPathPrefix);
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.watch)(props.node, async () => {
      _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].debug('Node has changed', {
        node: {
          ...props.node
        },
        folder: {
    ...
    async function getArchiveInfo(fileName) {
      ...
      const url = (0,_toolkit_util_generate_url_ts__WEBPACK_IMPORTED_MODULE_18__["default"])('archive/info/{fileName}', {
        fileName
      });
      const requestData = {};
      ...
      try {
        ...
        _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].error('ERROR', e);
        if ((0,_toolkit_types_axios_type_guards_ts__WEBPACK_IMPORTED_MODULE_15__.isAxiosErrorResponse)(e) && e.response.data) {
    ...
    async function refreshArchiveMounts(filename, noEmit) {
      ...
      for (const mount of deletedMounts) {
        const node = (0,_toolkit_util_file_node_helper_ts__WEBPACK_IMPORTED_MODULE_17__.fileInfoToNode)(mount.mountPoint);
    ...
    const getJobIdFromOperation = (operation, archivePath, mountPath) => {
      return (0,js_md5__WEBPACK_IMPORTED_MODULE_9__.md5)(operation + archivePath + mountPath);
    };
    ...
    async function getPendingJobs(fileName, silent) {
      ...
      fileName = encodeURIComponent(fileName);
      const url = (0,_toolkit_util_generate_url_ts__WEBPACK_IMPORTED_MODULE_18__["default"])('archive/schedule/{operation}/{fileName}', {
        operation: 'status',
        fileName
      });
      try {
    ...
    const cancelPendingOperation = async operation => {
      ...
      const url = (0,_toolkit_util_generate_url_ts__WEBPACK_IMPORTED_MODULE_18__["default"])('archive/schedule/{operation}/{archivePath}/{mountPath}', {
        operation,
        archivePath,
        mountPath
      });
      ...
      try {
        ...
        _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].error('ERROR', e);
        if ((0,_toolkit_types_axios_type_guards_ts__WEBPACK_IMPORTED_MODULE_15__.isAxiosErrorResponse)(e)) {
          const messages = [];
          if (e.response.data) {
          ...
          if (!messages.length) {
            messages.push((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)(_config_ts__WEBPACK_IMPORTED_MODULE_13__.appName, 'Cancelling the background job failed with error {status}, "{statusText}".', {
    ...
    async function getArchiveMounts(fileName, silent) {
      ...
      fileName = encodeURIComponent(fileName);
      const url = (0,_toolkit_util_generate_url_ts__WEBPACK_IMPORTED_MODULE_18__["default"])('archive/mount/{fileName}', {
        fileName
      });
      try {
        const response = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_2__["default"].get(url);
    ...
    const mountArchive = async () => {
      ...
      const url = (0,_toolkit_util_generate_url_ts__WEBPACK_IMPORTED_MODULE_18__["default"])(urlTemplate, {
        archivePath,
        mountPath
      });
      setBusyState(true);
      ...
      try {
        ...
        if (!archiveMountBackgroundJob.value) {
          ...
          if (archiveMounts.value.findIndex(mount => mount.mountPoint.fileid === newFileId) === -1) {
            ...
            const node = (0,_toolkit_util_file_node_helper_ts__WEBPACK_IMPORTED_MODULE_17__.fileInfoToNode)(response.data.mountPoint);
            node.attributes['is-mount-root'] = true;
            (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_4__.emit)('files:node:created', node);
          }
        }
        ...
        if ((0,_toolkit_types_axios_type_guards_ts__WEBPACK_IMPORTED_MODULE_15__.isAxiosErrorResponse)(e)) {
          ...
          if (!messages.length) {
            messages.push((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)(_config_ts__WEBPACK_IMPORTED_MODULE_13__.appName, 'Mount request failed with error {status}, "{statusText}".', {
              status: e.response.status,
              statusText: e.response.statusText
            }));
          }
    ...
    const unmount = async mount => {
      ...
      try {
        ...
        if (mountIndex >= 0) {
          ...
          _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].error('UNABLE TO FIND DELETED MOUNT IN LIST', mount, archiveMounts);
        }
        const node = (0,_toolkit_util_file_node_helper_ts__WEBPACK_IMPORTED_MODULE_17__.fileInfoToNode)(mount.mountPoint);
        node.attributes['is-mount-root'] = true;
        (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_4__.emit)('files:node:deleted', node);
        ...
        if ((0,_toolkit_types_axios_type_guards_ts__WEBPACK_IMPORTED_MODULE_15__.isAxiosErrorResponse)(e)) {
          ...
          if (!messages.length) {
            messages.push((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)(_config_ts__WEBPACK_IMPORTED_MODULE_13__.appName, 'Unmount request failed with error {status}, "{statusText}".', {
              status: e.response.status,
              statusText: e.response.statusText
            }));
          }
    ...
    const extractArchive = async () => {
      ...
      try {
        ...
        if (!archiveExtractBackgroundJob.value) {
          const node = (0,_toolkit_util_file_node_helper_ts__WEBPACK_IMPORTED_MODULE_17__.fileInfoToNode)(response.data.targetFolder);
          node.attributes['is-mount-root'] = true;
          (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_4__.emit)('files:node:created', node);
        }
      } catch (e) {
        ...
        if ((0,_toolkit_types_axios_type_guards_ts__WEBPACK_IMPORTED_MODULE_15__.isAxiosErrorResponse)(e)) {
          ...
          if (!messages.length) {
            messages.push((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)(_config_ts__WEBPACK_IMPORTED_MODULE_13__.appName, 'Archive extraction failed with error {status}, "{statusText}".', {
              status: e.response.status,
              statusText: e.response.statusText
            }));
          }
    ...
    const setPassPhrase = async () => {
      const newPassPhrase = showArchivePassPhrase.value ? archivePassPhraseComponent.value.$el.querySelector('input[type="text"]')?.value || '' : archivePassPhraseComponent.value.$el.querySelector('input[type="password"]')?.value || '';
      archivePassPhrase.value = newPassPhrase;
      // patch it into existing mounts if any
      const archivePath = encodeURIComponent(fileName.value);
      const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_7__.generateUrl)('/apps/' + _config_ts__WEBPACK_IMPORTED_MODULE_13__.appName + '/archive/mount/{archivePath}', {
        archivePath
      });
      setBusyState(true);
      const requestData = {
      ...
      try {
        ...
        if ((0,_toolkit_types_axios_type_guards_ts__WEBPACK_IMPORTED_MODULE_15__.isAxiosErrorResponse)(e)) {
          ...
          if (!messages.length) {
            messages.push((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_6__.translate)(_config_ts__WEBPACK_IMPORTED_MODULE_13__.appName, 'Patching the passphrase failed with error {status}, "{statusText}".', {
              status: e.response.status,
              statusText: e.response.statusText
            }));
          }
    ...
    const onNotification = event => {
      if (event?.notification?.app !== _config_ts__WEBPACK_IMPORTED_MODULE_13__.appName) {
        return;
      }
      ...
      if (!mountData) {
        _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].error('No mount info in mount notification event');
        return;
      }
      let mount;
      try {
        ...
        _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].error('files_archive, unable to decode mount entity', {
          event,
          mountData,
          error
        });
      ...
      if (mount.archiveFileId !== archiveFileId.value) {
        ...
        _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].info('*** Archive notification for other file received', event);
        return;
      }
      ...
      _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].info('*** Mount notification received, updating mount-list', destinationData);
      ...
      if (mountIndex === -1) {
        try {
          ...
          _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].error('Unable to decode mount point folder file-info record.', {
            destinationData,
            error
          });
        }
    ...
    const onMountPointRenamed = mountPoint => {
      ...
      const mountIndex = archiveMounts.value.findIndex(mount => mount.mountPoint.fileid === mountFileId);
      if (mountIndex >= 0) {
        _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].info('BERFORE RENAME', {
          ...archiveMounts[mountIndex]
        });
        const mount = archiveMounts[mountIndex];
        mount.mountPoint = mountPoint;
        mount.mountPointPath = mountPoint.path;
        mount.mountPointPathHash = (0,js_md5__WEBPACK_IMPORTED_MODULE_9__.md5)(mountPoint.path);
        _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].info('AFTER RENAME', {
          ...mount
        });
      } else {
        _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].info('RENAME OF NODE NOT FOR US', mountPoint);
      }
    };
    const onMountPointDeleted = mountPoint => {
      ...
      if (mountIndex >= 0) {
        archiveMounts.value.splice(mountIndex, 1);
        _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].info('RECORD UNMOUNT', mountPoint);
      } else {
        _console_ts__WEBPACK_IMPORTED_MODULE_14__["default"].info('DELETE OF NODE NOT FOR US', {
          mountPoint,
    ...
    const __returned__ = {
      ...
      FilePrefixPicker: _rotdrop_nextcloud_vue_components_lib_components_FilePrefixPicker_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
      CancelIcon: vue_material_design_icons_Cancel_vue__WEBPACK_IMPORTED_MODULE_11__["default"],
      NetworkOffIcon: vue_material_design_icons_NetworkOff_vue__WEBPACK_IMPORTED_MODULE_12__["default"],
      get appName() {
        return _config_ts__WEBPACK_IMPORTED_MODULE_13__.appName;
      }
    };
    Object.defineProperty(__returned__, '__isScriptSetup', {
      enumerable: false,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.displayDirName), 1 /* TEXT */)])), [[_directive_tooltip, $setup.unclippedPopup($setup.pathInfo.dirName)]]), !$props.onlyDirName ? (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["TextFieldWithSubmitButton"], {
    key: 0,
  ...
  }, null, 8 /* PROPS */, ["modelValue", "label", "placeholder", "readonly", "disabled"])), [[_directive_tooltip, $setup.unclippedPopup($setup.pathInfo.baseName)]]) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]);
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("ul", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", {
    ...
    onClick: _cache[1] || (_cache[1] = $event => $setup.showArchiveInfo = !$setup.showArchiveInfo)
    ...
    icon: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [...(_cache[21] || (_cache[21] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
      class: "icon-error"
    }, null, -1 /* CACHED */)]))]),
    _: 1 /* STABLE */
    ...
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["name"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, !$setup.loading]])], 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, $setup.showArchiveInfo]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", _hoisted_6, [_cache[22] || (_cache[22] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [$setup.showArchivePassPhrase ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["NcActionInput"], {
      key: 0,
      ref: "archivePassPhraseComponent",
      modelValue: $setup.archivePassPhrase,
      "onUpdate:modelValue": _cache[2] || (_cache[2] = $event => $setup.archivePassPhrase = $event),
      type: "text",
      icon: "icon-password",
      ...
      _: 1 /* STABLE */
    }, 8 /* PROPS */, ["modelValue"])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["NcActionInput"], {
      key: 1,
      ref: "archivePassPhraseComponent",
      modelValue: $setup.archivePassPhrase,
      ...
      onChange: $setup.togglePassPhraseVisibility
    }, {
      default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.t($setup.appName, 'Show Passphrase')), 1 /* TEXT */)]),
      _: 1 /* STABLE */
    })]),
    _: 1 /* STABLE */
  })]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("li", {
    class: "files-tab-entry flex flex-center clickable",
    onClick: _cache[5] || (_cache[5] = $event => $setup.showArchiveMounts = !$setup.showArchiveMounts)
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["NcListItem"], {
      ...
      }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(mountPoint.mountPointPath), 1 /* TEXT */)], 8 /* PROPS */, _hoisted_17)), [[_directive_tooltip, mountPoint.mountPointPath]])]),
      actions: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["NcActionButton"], {
        ...
        icon: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["NetworkOffIcon"], {
          size: 20
        }, null, 512 /* NEED_PATCH */), [[_directive_tooltip, $setup.t($setup.appName, 'Disconnect storage')]])]),
        _: 1 /* STABLE */
      }, 8 /* PROPS */, ["onClick"])]),
      _: 2 /* DYNAMIC */
    ...
    "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => $setup.archiveMountFileInfo = $event),
    ...
    default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["NcActionCheckbox"], {
      ...
      "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => $setup.archiveMountStripCommonPathPrefix = $event),
      onChange: _cache[8] || (_cache[8] = $event => $setup.archiveMountStripCommonPathPrefix = !$setup.archiveMountStripCommonPathPrefix)
    }, {
      ...
      "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => $setup.archiveMountBackgroundJob = $event),
      onChange: _cache[10] || (_cache[10] = $event => $setup.archiveMountBackgroundJob = !$setup.archiveMountBackgroundJob)
    }, {
    ...
    class: "files-tab-entry flex flex-center clickable",
    onClick: _cache[12] || (_cache[12] = $event => $setup.showArchiveExtraction = !$setup.showArchiveExtraction)
    ...
    default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["NcActionButton"], {
      ...
      "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => $setup.showArchiveExtraction = $event),
    ...
    "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => $setup.archiveExtractFileInfo = $event),
    ...
    default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["NcActionCheckbox"], {
      ...
      "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => $setup.archiveExtractStripCommonPathPrefix = $event),
      onChange: _cache[15] || (_cache[15] = $event => $setup.archiveExtractStripCommonPathPrefix = !$setup.archiveExtractStripCommonPathPrefix)
    }, {
      default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.t($setup.appName, 'strip common path prefix')), 1 /* TEXT */)]),
      _: 1 /* STABLE */
    }, 8 /* PROPS */, ["modelValue"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["NcActionCheckbox"], {
      modelValue: $setup.archiveExtractBackgroundJob,
      "onUpdate:modelValue": _cache[16] || (_cache[16] = $event => $setup.archiveExtractBackgroundJob = $event),
      onChange: _cache[17] || (_cache[17] = $event => $setup.archiveExtractBackgroundJob = !$setup.archiveExtractBackgroundJob)
    }, {
      default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.t($setup.appName, 'schedule as background job')), 1 /* TEXT */)]),
      _: 1 /* STABLE */
    }, 8 /* PROPS */, ["modelValue"])]),
    ...
    class: "files-tab-entry flex flex-center clickable",
    onClick: _cache[19] || (_cache[19] = $event => $setup.showPendingJobs = !$setup.showPendingJobs)
    ...
    default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["NcActionButton"], {
      ...
      "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => $setup.showPendingJobs = $event),
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)($setup["NcListItem"], {
      ...
      actions: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["NcActionButton"], {
        ...
        icon: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)($setup["CancelIcon"], {
          size: 20
        }, null, 512 /* NEED_PATCH */), [[_directive_tooltip, $setup.t($setup.appName, 'Cancel Job')]])]),
        _: 1 /* STABLE */
      }, 8 /* PROPS */, ["onClick"])]),
      _: 2 /* DYNAMIC */
...
//# sourceMappingURL=src_views_FilesTab_vue-2c82718c6b7cb6c1224c.js.map