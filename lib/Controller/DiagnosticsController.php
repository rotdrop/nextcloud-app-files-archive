...
class DiagnosticsController extends Controller
{
  ...
  public function archiveFormats():DataResponse
  {
    return self::dataResponse([
      'html' => $this->runArchiveCommand(ArchiveCommands\FormatsCommand::class, [ 'driver' => null, ]),
    ]);
  }
  ...
  {
    return self::dataResponse([
      'html' => $this->runArchiveCommand(ArchiveCommands\DriversCommand::class),
    ]);
  }
  ...
  {
    return self::dataResponse([
      'html' => $this->runArchiveCommand(ArchiveCommands\FormatCommand::class, [ 'format' => $format ]),
    ]);
  }
   ...
   *
   * @return string The ouput generated by the command.
   */
  private function runArchiveCommand(string $commandClass, array $arguments = []):string
  {
    ...
    $content = (new AnsiConverter\AnsiToHtmlConverter(
      new AnsiConverter\Theme\SolarizedTheme(),
    ))->convert($output->fetch());
